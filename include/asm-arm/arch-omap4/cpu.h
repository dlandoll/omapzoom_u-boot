...
#define DMM_LISA_MAP_SDRC_ADDRSPC_MASK	(3 << 16)
#define DMM_LISA_MAP_SDRC_ADDRSPC_SHIFT	16
#define DMM_LISA_MAP_SDRC_MAP_MASK	(3 << 8)
#define DMM_LISA_MAP_SDRC_MAP_SHIFT	8

/* SDRAM controller address spaces */
#define DMM_SDRC_ADDRSPC_SDRAM		0
#define DMM_SDRC_ADDRSPC_LPDDR2_NVM	1
#define DMM_SDRC_ADDRSPC_RESERVED	2
#define DMM_SDRC_ADDRSPC_INTERNAL_REGS	3
