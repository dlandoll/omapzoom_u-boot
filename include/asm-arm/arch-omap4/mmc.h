 ...
 *
 *  Based on the file include/asm-arm/arch-pxa/mmc.h,
 *  with the below copyright.
 ...
 *
 *  History: 05/03/08
 *  Modified for use in omap3 MMC driver.
 */
#ifndef __MMC_OMAP_H__
#define __MMC_OMAP_H__
